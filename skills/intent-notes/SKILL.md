---
name: intent-notes
description: Record why the current change was made — a note under docs/notes plus the comments on what changed. Use when the user asks to account for a current change, to write the note for it, or explicitly requests intent notes.
---
